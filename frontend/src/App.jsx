...
export default function App() {
  ...
  const [thinkSuggestion, setThinkSuggestion] = useState(null);
  const [lastThinkData, setLastThinkData] = useState(null);
  ...
  const handleSend = async () => {
    ...
    if (thinkMode) {
      ...
      try {
        ...
        // Guard: se o servidor retornar HTML (offline/502), lança erro legível
